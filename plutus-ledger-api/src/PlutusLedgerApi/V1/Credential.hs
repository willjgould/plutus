...
-- New PlutusTx.Ord instance
instance PlutusTx.Ord Credential where
    {-# INLINEABLE compare #-}
    compare (PubKeyCredential l) (PubKeyCredential r) =
        compare l r
    compare (PubKeyCredential _) (ScriptCredential _) =
        LT
    compare (ScriptCredential _) (PubKeyCredential _) =
        GT
    compare (ScriptCredential a) (ScriptCredential b) =
        compare a b
